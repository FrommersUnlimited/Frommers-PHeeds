							...
							<div class="feedName"><a href="#feed_item_of_interest" class="feedViewAction">item_of_interest.feed</a></div>
								...
								<div class="detailGroup">
									...
									<?php if ($address["email"]) { ?>
										<tr><th>Email</th><td><a href="<?php echo $address["email"]; ?>"><?php echo $address["email"]; ?></a></td></tr>	
									<?php } ?>
									<?php if ($address["fax"]) { ?>
									...
									<?php if ($locationInfo->link) {
										...
										<tr><th>Website</th><td><a href="http://<?php echo $link["url"]; ?>"><?php echo $link["name"]; ?></a></td></tr>
									<?php } ?>
											...
											<tr>
												...
												<td>
													<?php foreach ($itemOfInterest->links->link as $key=>$link) { ?>
														<a href="http://<?php echo $link["url"]; ?>"><?php echo $link["name"]; ?></a><br />
													<?php } ?>
												</td>
											</tr>
										</table>
